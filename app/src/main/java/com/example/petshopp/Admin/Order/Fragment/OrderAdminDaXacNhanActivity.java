...
public class OrderAdminDaXacNhanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xacnhanadmindeteail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OrderAdminDaXacNhanActivity.this, OrderActivity.class);
                intent.putExtra("navigateToDaXacFragment", true);
    ...
    private void loadOrderDetails() {
        ...
        orderReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new OrderProductAdminAdapter(OrderAdminDaXacNhanActivity.this, mCartItems);
