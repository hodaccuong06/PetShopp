...
public class OrderChuaXacNhanAdminAdapter extends RecyclerView.Adapter<OrderChuaXacNhanAdminAdapter.MyOrderDetailViewHolder>{
    ...
    public OrderChuaXacNhanAdminAdapter(Context context, ArrayList<Order> mOrderList) {
    ...
    @NonNull
    @Override
    public MyOrderDetailViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyOrderDetailViewHolder holder, int position) {
        ...
        if (products != null && !products.isEmpty()) {
            ...
            holder.tinhtrangadmin.setTextColor(holder.itemView.getContext().getResources().getColor(R.color.red));
