...
public class OrderDetailAdapter extends RecyclerView.Adapter<OrderDetailAdapter.HolderOrderDetail>{
    private Context mContext;
    private ArrayList<CartItem> mCartItems;
    public OrderDetailAdapter(Context mContext, ArrayList<CartItem> mCartItems) {
    ...
    @Override
    public void onBindViewHolder(@NonNull OrderDetailAdapter.HolderOrderDetail holder, int position) {
